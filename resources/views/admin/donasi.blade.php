    ...
    <div class="modal fade" id="modal-tambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="form-donate" method="POST" action="{{ route('admin.donasi.tambah') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" min="0" class="form-control rupiah"  id="raised" name="raised"
                                        required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" min="0" class="form-control rupiah"  id="goal" name="goal"
                                        required>
                                </div>
                            </div>
                            <div class="col-lg-6">
    ...
    <div class="modal fade" id="modal-edit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="e-form-donate" method="POST" action="{{ route('admin.donasi.edit') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">Raised (Rp)</label>
                                    <input type="text" min="0" class="form-control rupiah" id="e_raised" name="raised"
                                        >
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">Goal (Rp)</label>
                                    <input type="text" min="0" class="form-control rupiah" id="e_goal" name="goal"
                                        required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">Tanggal selesai</label>
                                    <input type ="date" class="form-control" id="v_end_date" name="end_date"
                                        required>
                                </div>
                            </div>
                            <div class="col-lg-6">
    ...
    <script type="text/javascript">
        ...
        function hapus(id) {
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = "{{ URL::to('admin/donasi/hapus') }}" + '/' + id;
                } else {
                    Swal.fire({
                        icon: 'error',
                        text: "Batal Hapus",
