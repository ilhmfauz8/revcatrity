...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-3">Pendapatan Admin (Rp)</h4>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-3">Pengeluaran (Rp)</h4>
                    <div class="widget-box-2">
                        <div class="widget-detail-2 text-end">
                            <h2 class="fw-normal mb-1"> {{ number_format($total_pengeluaran_penampung,2,',','.') }} </h2>
                            <p class="text-muted mb-3">Pengeluaran</p>
                        </div>
                        <div class="progress progress-bar-alt-success progress-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-box-2">
                        <div class="widget-detail-2 text-end">
                            ...
                            <p class="text-muted mb-3">Pendapatan</p>
                        </div>
                        <div class="progress progress-bar-alt-success progress-sm">
                            <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="100" aria-valuemin="0"
                                aria-valuemax="100" style="width: 100%;">
...
<script type="text/javascript">
    ...
    function defaultJumlahTransaksi(){
        ...
        $.get("{{ URL::to('penampung/dashboard-penampung/jumlah-transaksi') }}",{tahun:tahun},function(res){
    ...
    function defaultTotalLapor(){
        ...
        $.get("{{ URL::to('penampung/dashboard-penampung/total-lapor') }}",{tahun:tahun},function(res){
            var data = JSON.parse(res);
            setTotalLapor(data);
        });
    }
